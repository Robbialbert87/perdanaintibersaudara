...
@section('title', 'Verifikasi Purchase Order - (PIB) Perdana Inti Bersaudara')
    ...
    <div class="container">
        <div class="verify-card card">
            <div class="verify-header">
                ...
                <h2>VERIFIKASI DOKUMEN PURCHASE ORDER</h2>
            </div>
            <div class="verify-body text-center">
                ...
                <table class="verify-detail-table text-start">
                    <tr class="divider">
                        ...
                        <td class="value">: {{ $purchaseOrder->nomor_surat }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="value">: {{ ucfirst($purchaseOrder->status) }}</td>
                    </tr>
                    @endif
                    <tr class="divider">
