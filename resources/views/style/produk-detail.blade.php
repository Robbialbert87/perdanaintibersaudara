                ...
                <div class="col-lg-6" data-aos="fade-right">
                    ...
                    @if(count($media) > 0)
                            ...
                            <div class="swiper product-swiper rounded-4 shadow-sm" style="border: 1px solid rgba(0,0,0,0.05); overflow: hidden;">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        @else
                                        <div style="aspect-ratio: 1/1; overflow: hidden; background-color: #000;" class="d-flex align-items-center justify-content-center position-relative video-slide">
                        ...
                        @else
                            ...
                            @else
                            <div class="rounded-4 shadow-sm" style="border: 1px solid rgba(0,0,0,0.05); overflow: hidden; aspect-ratio: 1/1; background-color: #000;">
