...
@section('title', 'Verifikasi Kartu Garansi - (PIB) Perdana Inti Bersaudara')
    ...
    <div class="container">
        <div class="verify-card card">
            <div class="verify-header">
                ...
                <h2>VERIFIKASI KARTU GARANSI</h2>
            </div>
            <div class="verify-body text-center">
                ...
                <table class="verify-detail-table text-start">
                    <tr class="divider">
                        <td class="label">No Kartu Garansi</td>
                        <td class="value">: {{ $warrantyCard->nomor_kartu }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="label">RS / Klinik</td>
                        <td class="value">: {{ $warrantyCard->nama_rs_klinik }}</td>
                    </tr>
                    <tr>
                        <td class="label">Tgl Instalasi</td>
                        <td class="value">: {{ \Carbon\Carbon::parse($warrantyCard->tgl_instalasi)->locale('id')->translatedFormat('d F Y') }}</td>
                    </tr>
                    <tr class="divider">
