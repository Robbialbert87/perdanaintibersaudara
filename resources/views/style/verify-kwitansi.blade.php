...
@section('title', 'Verifikasi Kwitansi - (PIB) Perdana Inti Bersaudara')
            ...
            <div class="verify-body text-center">
                ...
                <table class="verify-detail-table text-start">
                    <tr class="divider">
                        ...
                        <td class="value">: {{ $kwitansi->nomor_kwitansi }}</td>
                    </tr>
                    <tr>
                        <td class="label">Diterima Dari</td>
                        <td class="value">: {{ $kwitansi->customer->nama_instansi }}</td>
                    </tr>
                    <tr>
                        <td class="label">Jumlah</td>
                        <td class="value">: Rp {{ number_format($kwitansi->jumlah, 0, ',', '.') }}</td>
                    </tr>
                    <tr>
                        <td class="label">Untuk Pembayaran</td>
                        <td class="value">: {{ $kwitansi->untuk_pembayaran ?? '-' }}</td>
                    </tr>
                    <tr class="divider">
                        <td class="label">Tanggal</td>
                        <td class="value">: {{ \Carbon\Carbon::parse($kwitansi->tanggal)->locale('id')->translatedFormat('d F Y') }}</td>
                    </tr>
                    <tr>
