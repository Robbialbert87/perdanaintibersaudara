...
@section('title', 'Verifikasi Penawaran - (PIB) Perdana Inti Bersaudara')
    ...
    <div class="container">
        <div class="verify-card card">
            <div class="verify-header">
                ...
                <h2>VERIFIKASI DOKUMEN PENAWARAN</h2>
            </div>
            <div class="verify-body text-center">
                ...
                <table class="verify-detail-table text-start">
                    <tr class="divider">
                        ...
                        <td class="value">: {{ $quotation->nomor_surat }}</td>
                    </tr>
                    <tr>
                        <td class="label">Tanggal</td>
                        <td class="value">: {{ \Carbon\Carbon::parse($quotation->tanggal)->locale('id')->translatedFormat('d F Y') }}</td>
                    </tr>
                    <tr>
