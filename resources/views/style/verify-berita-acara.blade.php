...
@section('title', 'Verifikasi Berita Acara - (PIB) Perdana Inti Bersaudara')
        ...
        <div class="verify-card card">
            ...
            <div class="verify-body text-center">
                ...
                <table class="verify-detail-table text-start">
                    <tr class="divider">
                        <td class="label">No Berita Acara</td>
                        <td class="value">: {{ $beritaAcara->nomor_surat }}</td>
                    </tr>
                    <tr>
                        <td class="label">Tanggal</td>
                        <td class="value">: {{ \Carbon\Carbon::parse($beritaAcara->tanggal)->locale('id')->translatedFormat('d F Y') }}</td>
                    </tr>
                    <tr>
                        <td class="label">Kegiatan</td>
                        <td class="value">: {{ $beritaAcara->kegiatan }}</td>
                    </tr>
                    <tr>
                        <td class="label">Lokasi</td>
                        <td class="value">: {{ $beritaAcara->lokasi }}</td>
                    </tr>
                    <tr>
                        <td class="label">Penerima</td>
                        <td class="value">: {{ $beritaAcara->pihak_penerima_nama }}</td>
                    </tr>

                    @if($beritaAcara->status !== 'draft')
                    <tr>
                        <td class="label">Status</td>
                        <td class="value">: {{ ucfirst($beritaAcara->status) }}</td>
                    </tr>
                    @endif
                    <tr class="divider">
