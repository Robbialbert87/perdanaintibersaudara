                ...
                <div class="item-row ie-card">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="items[{{ $index }}][nama_item]" class="form-control nama-item-input" value="{{ $item->nama_item }}" placeholder="Nama Barang/Pekerjaan (Opsional)" data-autofilled="false">
                        </div>
                        <div class="col-md-6">
