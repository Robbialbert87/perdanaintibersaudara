...
<div class="card shadow-sm border-0 mb-4">
    <div class="card-header bg-white py-3">
        <h5 class="mb-0 text-primary"><i class="bi bi-cart-plus me-2"></i>Form Buat Purchase Order</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('purchase-orders.store') }}" method="POST" id="poForm">
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    ...
                    <input type="text" name="perihal_surat" class="form-control" placeholder="Contoh: Pengadaan Barang Kantor" value="{{ old('perihal_surat') }}">
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="kata_pengantar" class="form-control" rows="5" placeholder="Dengan Hormat,&#10;&#10;Bersama surat ini kami (PIB) Perdana Inti Bersaudara ingin memesan...">{{ old('kata_pengantar') }}</textarea>
            </div>

            <div class="mb-4">
                <label class="form-label">Catatan Tambahan (Opsional)</label>
                <textarea name="catatan" class="form-control" rows="3" placeholder="Contoh: Pengiriman ke gudang, syarat pembayaran, dll.">{{ old('catatan') }}</textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="kata_penutup" class="form-control" rows="3" placeholder="Demikian Purchase Order ini kami sampaikan. Terima kasih.">{{ old('kata_penutup') }}</textarea>
            </div>
            ...
            <div class="d-flex justify-content-between">
                ...
                <button type="submit" class="btn btn-primary"><i class="bi bi-save"></i> Buat Purchase Order</button>
            </div>
        </form>
    </div>
</div>
