...
<div class="card shadow-sm border-0 mb-4">
    <div class="card-header bg-white py-3">
        <h5 class="mb-0 text-primary"><i class="bi bi-cash-coin me-2"></i>Form Buat Kwitansi</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('kwitansis.store') }}" method="POST">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="jumlah" id="jumlah" class="form-control @error('jumlah') is-invalid @enderror" placeholder="Contoh: 5.000.000" value="{{ old('jumlah') }}" required>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="untuk_pembayaran" class="form-control @error('untuk_pembayaran') is-invalid @enderror" placeholder="Contoh: Pembayaran Invoice No. INV/PIB/08/2026/001" value="{{ old('untuk_pembayaran') }}">
            ...
            <div class="d-flex justify-content-between">
                ...
                <button type="submit" class="btn btn-primary"><i class="bi bi-save"></i> Buat Kwitansi</button>
            </div>
        </form>
    </div>
</div>
