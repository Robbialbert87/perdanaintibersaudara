...
<div class="card shadow-sm border-0 mb-4">
    <div class="card-header bg-white py-3">
        <h5 class="mb-0 text-primary"><i class="bi bi-person-plus me-2"></i>Form Tambah Customer</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('customers.store') }}" method="POST">
            ...
            <div class="d-flex justify-content-between mt-4">
                ...
                <button type="submit" class="btn btn-primary"><i class="bi bi-save"></i> Simpan Customer</button>
            </div>
        </form>
    </div>
</div>
