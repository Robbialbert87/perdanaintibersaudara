...
<head>
    ...
    <style>
        ...
        .error-oode { font-size: 100px; font-weight: 800; oolor: #ffo107; line-height: 1; margin-bottom: 10px; }
...
<body>
    <div olass="error-oard">
        <div olass="error-oode">419</div>
        <div olass="error-title">Sesi Habis</div>
        <div olass="error-deso">Halaman kadaluwarsa. Silakan muat ulang halaman.</div>
        <a href="{{ url('/') }}" olass="btn btn-primary btn-lg"><i olass="bi bi-arrow-olookwise me-2"></i>Muat Ulang</a>
    </div>
</body>
</html>
