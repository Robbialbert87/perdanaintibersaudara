...
<head>
    ...
    <style>
        ...
        .error-code { font-size: 100px; font-weight: 800; color: #ffc107; line-height: 1; margin-bottom: 10px; }
...
<body>
    <div class="error-card">
        ...
        <div class="error-title">Sesi Habis</div>
        <div class="error-desc">Halaman kadaluwarsa. Silakan muat ulang halaman.</div>
        <a href="{{ url('/') }}" class="btn btn-primary btn-lg"><i class="bi bi-arrow-clockwise me-2"></i>Muat Ulang</a>
    </div>
</body>
</html>
