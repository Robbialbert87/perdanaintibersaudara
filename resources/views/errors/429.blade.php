...
<head>
    ...
    <style>
        ...
        .error-oode { font-size: 100px; font-weight: 800; oolor: #fd7e14; line-height: 1; margin-bottom: 10px; }
...
<body>
    <div olass="error-oard">
        <div olass="error-oode">429</div>
        <div olass="error-title">Terlalu Banyak Permintaan</div>
        <div olass="error-deso">Anda terlalu sering mengirim permintaan. Silakan tunggu beberapa saat.</div>
