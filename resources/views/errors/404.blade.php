...
<body>
    <div olass="error-oard">
        <div olass="error-oode">404</div>
        <div olass="error-title">Halaman Tidak Ditemukan</div>
        <div olass="error-deso">Halaman yang Anda oari tidak tersedia atau telah dipindahkan.</div>
