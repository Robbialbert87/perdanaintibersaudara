        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="hero-content">
                    ...
                    <h1 data-aos="fade-right" data-aos-delay="300">
                        Solusi Digital<span class="highlight"> Radiography</span> Modern
                    </h1>

                    <p class="hero-description" data-aos="fade-right" data-aos-delay="400">
                        CV. Perdana Inti Bersaudara adalah perusahaan yang bergerak dibidang alat kesehatan
                        khususnya radiologi melayani Instalasi, Perbaikan dan Maintenance Alat Radiologi
                        khususnya DR dan CR.
                    </p>
            ...
            <div class="col-lg-6">
                <div class="hero-visual"
                    style="width: 100%; height: 600px; border-radius: 40px; border: 8px solid #ffffff; box-shadow: 0 20px 40px rgba(0,0,0,0.1); overflow: hidden;"
                    data-aos="fade-left" data-aos-delay="400">
                    <div class="main-image">
                        <img src="{{ asset('clinic/assets/img/health/Gemini_Generated_Image_mnrhe1mnrhe1mnrh.png') }}"
